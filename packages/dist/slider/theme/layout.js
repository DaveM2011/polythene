...
var createStyles = function createStyles(config) {
    ...
    return [{
        '.pe-slider': [_mixin2.default.vendorize({
            'user-select': 'none'
            ...
            ' .pe-slider__track': [_flex2.default.layoutHorizontal, _flex2.default.flexGrow(1), _mixin2.default.defaultTransition('transform', config.animation_duration), _mixin2.default.vendorize({
                'user-select': 'none'
            }, _config2.default.prefixes_user_select), {
                position: 'relative',
            ...
            ' .pe-slider__control': [_flex2.default.selfCenter, _mixin2.default.defaultTransition('transform, background', config.animation_duration), _mixin2.default.vendorize({
                'user-select': 'none'
            }, _config2.default.prefixes_user_select), {
                width: thumbSize + 'px',
                height: thumbSize + 'px',
                ...
                // touch area
                '&:before': [_mixin2.default.defaultTransition('background-color', config.animation_duration), {
                    content: '""',
                    position: 'absolute',
                    'border-radius': '50%',
                ...
                // border
                '&:after': [_mixin2.default.defaultTransition('border', config.animation_duration), positionBorder(thumbSize, config.thumb_border_width), {
                    content: '""',
                    position: 'absolute',
                    'border-radius': '50%',
                    'border-style': 'solid'
            ...
            ' .pe-slider__thumb': [_mixin2.default.defaultTransition('opacity', config.animation_duration), _mixin2.default.fit(), {
                '&, .pe-icon': {
                    width: 'inherit',
                    height: 'inherit'
                }
            ...
            ' .pe-slider__label': {
                ...
                'min-width': _config2.default.unit_icon_size + 'px',
                'text-align': 'center',
                'font-size': '16px',
                'font-weight': _config2.default.font_weight_medium
            },

            ' .pe-slider__track-part': [_flex2.default.flex(), _mixin2.default.vendorize({
                'user-select': 'none'
            }, _config2.default.prefixes_user_select), {
            ...
            ' .pe-slider__track-value, .pe-slider__track-rest': _flex2.default.layoutHorizontal,

            ' .pe-slider__track-bar': [_flex2.default.flex(), {
                position: 'relative',
                overflow: 'hidden'
            }],
            ' .pe-slider__track-bar-value': [_flex2.default.flex(), _mixin2.default.defaultTransition('transform, background-color', config.animation_duration), {
                height: config.bar_height + 'px'
            }],
            ...
            ' .pe-slider__ticks': [_flex2.default.layoutJustified, _mixin2.default.vendorize({
                'user-select': 'none'
            }, _config2.default.prefixes_user_select), {
                position: 'absolute',
            ...
            ' .pe-slider__pin': [_mixin2.default.vendorize({
                'transform': 'translateZ(0) scale(0) translate(0, 0)'
            }, _config2.default.prefixes_transform), _mixin2.default.vendorize({
                'transform-origin': 'bottom'
            }, _config2.default.prefixes_transform), _mixin2.default.defaultTransition('transform', '.11s'), {
                position: 'absolute',
                'z-index': 1,
                ...
                '&::before': [_mixin2.default.vendorize({
            ...
            '&.pe-slider--active:not(.pe-slider--ticks)': {
                ' .pe-slider__control': [_mixin2.default.vendorize({
                    'transform': 'scale(' + config.active_thumb_scale + ')'
                }, _config2.default.prefixes_transform), {
                    'border-width': scaledBorderWidth + 'px'
                }],
                // left side
                ' .pe-slider__track-value .pe-slider__track-bar-value': [_mixin2.default.vendorize({
                    'transform': 'translateX(' + -scaledThumbDiff + 'px)'
                }, _config2.default.prefixes_transform)],
                // right side
                ' .pe-slider__track-rest .pe-slider__track-bar-value': [_mixin2.default.vendorize({
                    'transform': 'translateX(' + scaledThumbDiff + 'px)'
                }, _config2.default.prefixes_transform)]
            },

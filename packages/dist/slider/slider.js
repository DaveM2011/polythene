...
var eventMoveType = window.PointerEvent ? 'pointermove' : 'ontouchmove' in window || window.DocumentTouch && document instanceof DocumentTouch ? 'touchmove' : 'mousemove';
var eventEndType = window.PointerEvent ? 'pointerup' : 'ontouchend' in window || window.DocumentTouch && document instanceof DocumentTouch ? 'touchend' : 'mouseup';
...
var generateTickMarks = function generateTickMarks(min, max, stepSize) {
    ...
    var s = steps + 1;
    while (s > 0) {
        items.push((0, _mithril2.default)('div', { class: CSS_CLASSES.tick }));
        s--;
    }
    return items;
};
...
var readRangeData = function readRangeData(ctrl) {
    if (ctrl.controlEl) {
        ...
        ctrl.controlWidth = _config2.default.thumb_size;
...
var createSlider = function createSlider(ctrl) {
    ...
    return [(0, _mithril2.default)('div', _extends({}, {
    ...
    }, interactiveTrack && !opts.disabled && !_polythene2.default.isTouch ? {
        onmousedown: onStartTrack
    } : null, interactiveTrack && !opts.disabled && _polythene2.default.isTouch ? {
        ontouchstart: onStartTrack
    } : null), [(0, _mithril2.default)('div', {
    ...
    }, (0, _mithril2.default)('div', { class: CSS_CLASSES.trackBar }, (0, _mithril2.default)('div', { class: CSS_CLASSES.trackBarValue }))), (0, _mithril2.default)('div', _extends({}, {
    ...
    }, !opts.disabled && !_polythene2.default.isTouch ? {
        onmousedown: onInitDrag
    } : null, !opts.disabled && _polythene2.default.isTouch ? {
        ontouchstart: onInitDrag
    } : null, opts.events ? opts.events : null, hasTicks ? {
        step: stepCount
    } : null), opts.icon ? (0, _mithril2.default)('div', { class: CSS_CLASSES.thumb }, opts.icon) : null), (0, _mithril2.default)('div', {
    ...
    }, (0, _mithril2.default)('div', { class: CSS_CLASSES.trackBar }, (0, _mithril2.default)('div', { class: CSS_CLASSES.trackBarValue }))), hasTicks && !opts.disabled ? (0, _mithril2.default)('div', { class: CSS_CLASSES.ticks }, generateTickMarks(ctrl.min, ctrl.max, stepCount)) : null, hasTicks && opts.pin && !opts.disabled ? (0, _mithril2.default)('div', {

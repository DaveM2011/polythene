...
var createStyles = function createStyles(config) {
    return [{
        '.pe-spinner-indeterminate': {
            ...
            ' .pe-spinner-indeterminate__animation': [_mixin2.default.vendorize({
            ...
            */
            ...
            ' .pe-spinner-indeterminate__circle': [_mixin2.default.fit(), _mixin2.default.vendorize({
                'animation': 'none'
            }, _config2.default.prefixes_animation), {
                'box-sizing': 'border-box',
                height: '100%',
            ...
            ' .pe-spinner-indeterminate__circle-clipper--left .pe-spinner-indeterminate__circle': [_mixin2.default.vendorize({
            ...
            ' .pe-spinner-indeterminate__circle-clipper--right .pe-spinner-indeterminate__circle': [_mixin2.default.vendorize({
                'transform': 'rotate(-129deg)'
            }, _config2.default.prefixes_transform), _mixin2.default.vendorize({
            ...
            */
            ' .pe-spinner-indeterminate__layer': [_mixin2.default.vendorize({
                'animation': 'indeterminateFillUnfillRotate ' + 4 * config.arc_time + 's ' + CURVE_INFINITE
            }, _config2.default.prefixes_animation), [1, 2, 3, 4].map(function (num) {
...
var layerAnimation = function layerAnimation(config, num) {
    return _defineProperty({}, '&.pe-spinner-indeterminate__layer--' + num, [_mixin2.default.vendorize({

...
var createView = function createView(ctrl) {
    ...
    var content = [opts.raised && opts.content ? (0, _mithril2.default)(_shadow2.default, {
        z: opts.z
    }) : null, opts.content || (0, _mithril2.default)('div', { class: CSS_CLASSES.animation }, 'Specific spinner missing')];
    ...
    view: function view(ctrl) {
        ...
        if (!ctrl.visible) {
            if (opts.hide !== undefined && !opts.hide || opts.show) {
                ...
                if (showDelay) {
                    setTimeout(function () {
                        return ctrl.visible = true, _mithril2.default.redraw();
                    }, showDelay);
                } else {
                    ctrl.visible = true;
                }
            ...
            if (opts.show !== undefined && !opts.show || opts.hide) {
                ...
                if (hideDelay) {
                    setTimeout(function () {
                        return ctrl.hide = true, _mithril2.default.redraw();
                    }, hideDelay);
                } else {
                    ctrl.hide = true;
                }
        ...
        if (ctrl.visible) {
            ...
            return (0, _mithril2.default)('span', { class: CSS_CLASSES.placeholder });
        }
    }
};

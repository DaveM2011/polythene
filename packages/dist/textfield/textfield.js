...
var startEventType = window.PointerEvent ? 'pointerdown' : 'ontouchstart' in window || window.DocumentTouch && document instanceof DocumentTouch ? 'touchstart' : 'mousedown';
...
var createView = function createView(ctrl) {
    ...
    }, [opts.label ? (0, _mithril2.default)('label', _defineProperty({
    ...
    }), opts.label) : null, (0, _mithril2.default)(inputTag, _extends({}, {
        ...
        onkeydown: function onkeydown(e) {
            if (e.which === 13) {
                ...
                setTimeout(function () {
                    ...
                    setTimeout(_mithril2.default.redraw, 250);
                }, 1);
            }
        }
    } : null, {
    ...
    opts.readonly !== undefined ? { readonly: true } : null, opts.pattern !== undefined ? { pattern: opts.pattern } : null, opts.maxlength !== undefined ? { maxlength: opts.maxlength } : null, opts.minlength !== undefined ? { minlength: opts.minlength } : null, opts.max !== undefined ? { max: opts.max } : null, opts.min !== undefined ? { min: opts.min } : null, opts.autofocus !== undefined ? { autofocus: opts.autofocus } : null, opts.required !== undefined ? { required: opts.required } : null, opts.tabindex !== undefined ? { tabindex: opts.tabindex } : null, opts.rows !== undefined ? { rows: opts.rows } : null))]), opts.counter ? (0, _mithril2.default)('div', { class: CSS_CLASSES.counter }, ctrl.value.length + ' / ' + opts.counter) : null, opts.help && !showError ? (0, _mithril2.default)('div', {
        class: [CSS_CLASSES.help, opts.focusHelp ? CSS_CLASSES.focusHelp : ''].join(' ')
    }, opts.help) : null, showError ? (0, _mithril2.default)('div', { class: CSS_CLASSES.error }, ctrl.error) : validates && !opts.help ? (0, _mithril2.default)('div', { class: CSS_CLASSES.errorPlaceholder }) : null];
...
var component = {
    controller: function controller() {
        ...
        error = opts.error || '',
            el = void 0,
            inputEl = _mithril2.default.prop(),

...
var createStyles = function createStyles(config) {
    return [{
        '.pe-textfield': [_mixin2.default.clearfix(), {
            position: 'relative',
            ...
            ' .pe-textfield__input-area': {
                ...
                '&:after': [_mixin2.default.defaultTransition('opacity', config.input_focus_border_animation_duration), {
                    position: 'absolute',
                    content: '""',
                    bottom: 0,
                    left: 0,
            ...
            '&.pe-textfield--floating-label': {
                ...
                ' .pe-textfield__label': [_mixin2.default.defaultTransition('all', config.floating_label_animation_duration), {
            ...
            ' .pe-textfield__error, .pe-textfield__error-placeholder, .pe-textfield__help, .pe-textfield__counter': {
                ...
                'line-height': _config2.default.line_height,
                'min-height': config.font_size_error * _config2.default.line_height + 'px'
            },
            ...
            ' .pe-textfield__help-focus': [_mixin2.default.defaultTransition('opacity'), {
                opacity: 0
            }],

...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; // contains icons
...
var _scrollTo = require('../common/scroll-to');
...
var _config = require('./theme/config');
...
var createScrollButton = function createScrollButton(ctrl, position, opts) {
    var scrollIconForward = opts.scrollIconForward || _theme2.default.arrowForward;
    var scrollIconBackward = opts.scrollIconBackward || _theme2.default.arrowBackward;

    return (0, _mithril2.default)(_iconButton2.default, {
...
var scrollToTab = function scrollToTab(ctrl, tabIndex) {
    ...
    if (currentLeft !== left) {
        var duration = Math.abs(currentLeft - left) / _config2.default.tabs_scroll_speed;
        var delaySeconds = _config2.default.tabs_scroll_delay || 0;
        setTimeout(function () {
            (0, _scrollTo2.default)({
                element: scroller,
                to: left,
                duration: Math.max(_config2.default.tabs_scroll_min_duration, duration),
...
var animateIndicator = function animateIndicator(selectedTabEl, animate, ctrl) {
    ...
    var duration = animate ? _config2.default.indicator_slide_min_duration : 0;
...
var createTab = function createTab(ctrl, opts, index, buttonOpts) {
    ...
    var tabButtonOptions = _extends({}, buttonOpts, {
        ...
        }, [buttonOpts.icon ? (0, _mithril2.default)(_icon2.default, buttonOpts.icon) : null, buttonOpts.label ? (0, _mithril2.default)('div', { class: CSS_CLASSES.label }, (0, _mithril2.default)('span', buttonOpts.label)) : null]),
    ...
    return (0, _mithril2.default)(_button2.default, tabButtonOptions);
};
...
var createView = function createView(ctrl) {
    ...
    var props = {
        ...
        config: function config(el, inited, context) {
            ...
            // handle scroll
            if (opts.scrollable && !_polythene2.default.isTouch) {
            ...
            _events2.default.subscribe('resize', onResize);

            context.onunload = function () {
                _events2.default.unsubscribe('resize', onResize);
            };
    ...
    opts.scrollable ? (0, _mithril2.default)('div', { class: CSS_CLASSES.scrollButtonOffset }) : null]);
    ...
    var tabIndicator = opts.hideIndicator ? null : (0, _mithril2.default)('div', {
    ...
    var content = [opts.scrollable ? scrollButtonLeft : null, (0, _mithril2.default)('div', {
